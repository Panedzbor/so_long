...
static void	set_tiles(t_gamedata *gd)
{
	...
	gd->collectible[0] = xpm_to_img(gd, "./my_assets/flour2+2.xpm", &dummy);
	gd->collectible[1] = xpm_to_img(gd, "./my_assets/flour2+1.xpm", &dummy);
	gd->collectible[2] = xpm_to_img(gd, "./my_assets/flour2.xpm", &dummy);
	gd->collectible[3] = xpm_to_img(gd, "./my_assets/flour2-1.xpm", &dummy);
	gd->collectible[4] = xpm_to_img(gd, "./my_assets/flour2-2.xpm", &dummy);
	gd->exit = xpm_to_img(gd, "./my_assets/door-closed.xpm", &dummy);
	gd->exitopen[0] = xpm_to_img(gd, "./my_assets/door-open3.xpm", &dummy);
	gd->exitopen[1] = xpm_to_img(gd, "./my_assets/door-open2.xpm", &dummy);
	gd->exitopen[2] = xpm_to_img(gd, "./my_assets/door-open1.xpm", &dummy);
	gd->exitopen[3] = xpm_to_img(gd, "./my_assets/door-open0.xpm", &dummy);
	gd->exitopen[4] = xpm_to_img(gd, "./my_assets/door-open.xpm", &dummy);
}
